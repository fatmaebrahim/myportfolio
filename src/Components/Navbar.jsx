    ...
    <div className='w-full fixed items-center bg-[#1E2233] z-10 flex flex-row justify-between h-[100px]'>
      ...
      <ul>
        ...
        <li className='w-[150px] h-[50px] flex justify-between items-center ml-[-90px] hover:ml-[-10px] duration-500 bg-[#8FABB8] rounded-lg'>
          <a className='flex flex-row justify-between items-center w-full text-white' href="https://drive.google.com/file/d/1tLZ_IDPverfE2LYrdmAtM8_xH-A13kFk/view?usp=sharing" target='blank'>
